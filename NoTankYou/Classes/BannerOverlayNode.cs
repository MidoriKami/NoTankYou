...
public sealed class BannerOverlayNode : SimpleComponentNode {
	...
	private void BuildTimelines() {
		AddTimeline(new TimelineBuilder()
			...
			.AddFrame(5, scale: new Vector2(0.95f, 0.95f), alpha: 150)
			.AddFrame(10, scale: new Vector2(1.0f, 1.0f), alpha: 255)
			.AddFrame(20, scale: new Vector2(1.0f, 1.0f), alpha: 255)
			.AddFrame(25, scale: new Vector2(0.95f, 0.95f), alpha: 150)
