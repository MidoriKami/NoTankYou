...
public class BannerOverlay
{
    ...
    public string SoloModeHelp => Loc.Localize("BannerOverlay_SoloMode", "Only display Warnings that are generated by you");
}
...
public class PartyOverlay
{
    ...
    public string Button => Loc.Localize("PartyOverlay_Button", "PartyFrame");
    public string SoloMode => Loc.Localize("PartyOverlay_SoloMode", "Solo Mode");
    public string SoloModeHelp => Loc.Localize("PartyOverlay_SoloMode", "Only display Warnings that are generated by you");
}
