...
namespace NoTankYou.Localization {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Disable while Role-playing.
        /// </summary>
        internal static string DisableWhileRolePlaying {
            get {
                return ResourceManager.GetString("DisableWhileRolePlaying", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Disables all modules while you have the Role-playing status effect (applicable in some main story quests).
        /// </summary>
        internal static string DisableWhileRolePlayingHelp {
            get {
                return ResourceManager.GetString("DisableWhileRolePlayingHelp", resourceCulture);
            }
        }
